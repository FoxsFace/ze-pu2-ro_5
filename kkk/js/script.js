require(['catiline'], function(cw) {
    var worker = cw({
        ...
        color:function(s){
            ...
            // return "#eee";
            // console.log(s)
            if (s.properties.PROPERTY_T == 5) {
            	return "#0d465f";
            }
            if (s.properties.PROPERTY_T == 4) {
            	return "#44748a";
            }
            if (s.properties.PROPERTY_T == 3) {
            	return "#004DFF";
            }
            if (s.properties.PROPERTY_T == 2) {
            	return "#486ab9";
            }
            if (s.properties.PROPERTY_T == 1) {
            	return "#8da2d1";
            }
            if (s.properties.PROPERTY_T == 0) {
            	return "#34671e";
            }
    ...
    function makeDone(div, upButton) {
        ...
        doneButton.innerHTML = "Загрузить";
